...
public class FinEstimatedIncomeDetailForExcel extends ExcelHandleData{
	...
	public List<Map<String, String>> HandleList(String dataSourceCode, List<Map<String, String>> dataList, TokenEntity tokenEntity) {
		...
		if (dataList.size() > 0) {
			for (int i = 0; i < dataList.size() - 1; i++) {
				...
				dataMap.put("DETAIL_TYPE", "0");// 详情类型
				dataMap.put("BALANCE", dataMap.get("ESTIMATED_INCOME"));// 余额
