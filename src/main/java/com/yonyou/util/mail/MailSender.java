...
//	}
	 ...
	 *
	 */
//	public void sendWithTemplate(Map<String,String> model){
...
//        String result = null;
//        try {
//			result = VelocityEngineUtils.mergeTemplateIntoString(this.velocityEngine, this.getTemplateName(), "UTF-8",model);
