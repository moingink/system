...
public class WarnEvery3Month_10Job extends QuartzJob {

	@Override
	protected boolean runJob(Map<String, Object> noticeData) {
		List<Map<String, Object>> query = BaseDao.getBaseDao().query("select w.* from warn_proj w LEFT JOIN qrtz_job_message q on q.ID=w.qrtz_job_message_id where w.dr ='0' and q.JOB_CLASS='com.yonyou.util.quartz.job.WarnEvery3Month_10Job'  ", "");
