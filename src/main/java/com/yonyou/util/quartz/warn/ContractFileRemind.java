 ...
 *
 */
public class ContractFileRemind  extends BaseWarn{
	public void execute(){

		//查询所有审批日期后7天、15天、30天的未归档的合同
		...
		String sql="select b.* ,ru.EMAIL from bus_contract_admin b LEFT JOIN rm_user ru on ru.ID=b.undertake_id  where  b.dr='1' and  b.con_file_state='0' ";
