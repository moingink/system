...
<%
System.out.println(tokenEntity.COMPANY.getCompany_id());
...
var ParentPKField1='<%=request.getParameter("ParentPKField1")!=null?request.getParameter("ParentPKField1"):""%>';
var ParentPKValue1='<%=request.getParameter("ParentPKValue1")!=null?request.getParameter("ParentPKValue1"):""%>';
var ParentPKField2='<%=request.getParameter("ParentPKField2")!=null?request.getParameter("ParentPKField2"):""%>';
var ParentPKValue2='<%=request.getParameter("ParentPKValue2")!=null?request.getParameter("ParentPKValue2"):""%>';

var _query_param='';
if(ParentPKField!=null&&ParentPKField.length>0){
		_query_param =pageParamFormat( ParentPKField+" = "+ParentPKValue +" and "+ParentPKField2+" = "+ParentPKValue2 );//这里做公司数据筛选
}	
