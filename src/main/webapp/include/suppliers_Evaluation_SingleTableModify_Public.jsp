...
var ParentPKField="EVALUATION_DEPARTMENT_ID";
var ParentPKValue=corpId;
var _query_param='';
if(ParentPKField!=null&&ParentPKField.length>0){
	<!-- _query_param =pageParamFormat("EVALUATION_DEPARTMENT_ID"+" = " + corpId +"&STATE=0"); -->
		_query_param =pageParamFormat(ParentPKField+" = "+ParentPKValue);//这里做公司数据筛选
}	
