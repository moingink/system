...
System.out.println("PARENT_PARTY_ID"+request.getParameter("PARENT_PARTY_ID"));
System.out.println("PARENT_PARTY_CODE"+request.getParameter("PARENT_PARTY_CODE"));
%>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div>
								...
								<button type="button" class="btn btn-success" onclick="saveAndSend(this)">
									<span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span>保存并发送
								</button>
							</div>
