...
//子表  数据源编码
var _dataSourceCode='RM_AUTHORIZE_RESOURCE';
//父表 主键[在子表的外键字段]
var ParentPKField='AUTHORIZE_ID';
//值
var ParentPKValue='';
...
function view(t){
	...
	var url =context+"/pages/demoChild.jsp?pageCode="+dataSourceCode+"&menuCode=DEMO&pageName=权限类别";
