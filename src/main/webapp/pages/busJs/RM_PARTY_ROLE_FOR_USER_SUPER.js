...
buttonJson =[
              {name:'查询',fun:'queryUser(this)',buttonToken:'query'},
              {name:'添加用户',fun:'addUser(this)',buttonToken:''},
...
function addUser(t){  
	...
	//alert(roleId);
	window.location.href=context+"/pages/singleTableModify.jsp?pageCode=RM_ROLE_FOR_USER&menuCode=001&pageName=用户列表&roleId="+roleId;
	}  


function queryUser(t) {
	var Request = new Object(); 
	Request = GetRequest();
	var roleId = Request['roleId'];
	//添加参数查询条件
	var param = " PR.ROLE_ID = '"+roleId+"' ";
