...
//子表  数据源编码
var _dataSourceCode='RM_PARTY_TYPE_RELATION_RULE';
//父表 主键[在子表的外键字段]
var ParentPKField='PARTY_VIEW_ID';
//值
var ParentPKValue='';
...
function view(t){
	...
	var url =context+"/pages/demoChild.jsp?pageCode="+dataSourceCode+"&menuCode=DEMO&pageName=团体视图";
