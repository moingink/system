buttonJson =[
             ...
             // {name:'新增部门',fun:'addDepartment(this)',buttonToken:'addDepartment',buttonType:'super'},
              ...
              {name:'参照部门',fun:'queryTable(this)',buttonToken:'query',buttonType:'super'},/*
              {name:'参照部门',fun:'queryTable2(this)',buttonToken:'query',buttonType:'super'},*/
              
              {name:'修改',fun:'newUpdate(this)',buttonToken:'',buttonType:'super'},
...
/*function addDepartment(t){	
	var depDataSourceCode="TM_DEPARTMENT";
	var parentCode = $("#PARENT_PARTY_CODE").val();
	var url =context+"/pages/partyAdd.jsp?pageCode="+depDataSourceCode+"&menuCode=DEMO"+"&ParentPartyCode="+parentCode;
	url=appendChildUrl(url,depDataSourceCode,ParentPKField,ParentPKValue);
