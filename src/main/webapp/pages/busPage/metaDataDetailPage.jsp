...
<html lang="zh-cn">
	...
	<body>
		...
		<!--主表主键 FOR 查询-->
		<input type="hidden" id="SEARCH-METADATA_ID">

		<script>
			var dataSourceCode = "CD_METADATA_DETAIL";
			var tabName = "CD_METADATA_DETAIL";
			...
			$(function() {
				$("[id='SEARCH-METADATA_ID'],#METADATA_ID").val(getURLParameter("METADATA_ID"));
				bulidTable();
			});
			...
			function back(){
				tog();
				//排除主表主键
				$inspage.find('[id]').not("#METADATA_ID").val("");
				$("#is_edit").val("");
			}
