...
<html lang="zh-cn">
	...
	<script type="text/javascript">
		$(function() {
			...
			bulidMaintainPage($("#superInsertPage"),"DOUBLE_IMPORT_CHANGE",mainPageParam);
			bulidListPage($("#table"),'DOUBLE_IMPORT_CHANGE_DETAIL',pageParamFormat("PARENT_ID = <%=request.getParameter("id")%>"));
