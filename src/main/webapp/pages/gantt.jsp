...
<title>Insert title here</title>
  ...
  <link rel=stylesheet href="../pro_all_jses/platform.css" type="text/css">
...
<div class="__template__" type="TASKROW"><!--
 <tr id="tid_(#=obj.id#)" taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
    ...
    <td class="gdfCell"><input type="text" id="start_time" name="start"  value="" class=""></td>
    <td class="gdfCell" align="center"><input type="checkbox" name="endIsMilestone"></td>
    <td class="gdfCell"><input type="text" id="ENDALL" name="end" value="" class=""></td>
