...
<title>Insert title here</title>
  ...
  <link rel=stylesheet href="../pro_all_jses/platform_Pmo.css" type="text/css">
  <link rel=stylesheet href="../pro_all_jses/libs/jquery/dateField/jquery.dateField.css" type="text/css">

  <link rel=stylesheet href="../pro_all_jses/gantt.css" type="text/css">
  <link rel=stylesheet href="../pro_all_jses/ganttPrint.css" type="text/css" media="print">

  <script src="../pro_all_jses/libs/jquery.min.js"></script>
  <script src="../pro_all_jses/libs/jquery-ui.min.js"></script>

  <script src="../pro_all_jses/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
  <script src="../pro_all_jses/libs/jquery/jquery.timers.js"></script>

  <script src="../pro_all_jses/libs/utilities.js"></script>
  <script src="../pro_all_jses/libs/forms.js"></script>
  <script src="../pro_all_jses/libs/date.js"></script>
  <script src="../pro_all_jses/libs/dialogs.js"></script>
  <script src="../pro_all_jses/libs/layout.js"></script>
  <script src="../pro_all_jses/libs/i18nJs.js"></script>
  <script src="../pro_all_jses/libs/jquery/dateField/jquery.dateField.js"></script>
  <script src="../pro_all_jses/libs/jquery/JST/jquery.JST.js"></script>

  <script type="text/javascript" src="../pro_all_jses/libs/jquery/svg/jquery.svg.min.js"></script>
  <script type="text/javascript" src="../pro_all_jses/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


  <script src="../pro_all_jses/ganttUtilities.js"></script>
  <script src="../pro_all_jses/ganttTasks.js"></script>
  <script src="../pro_all_jses/ganttDrawerSVG.js"></script>
  <script src="../pro_all_jses/ganttZoom.js"></script>
  <script src="../pro_all_jses/ganttGridEditor.js"></script>
  <script src="../pro_all_jses/ganttMaster.js"></script>
<!--   <script src="../pro_all_jses/libs/profiling.js"></script>
  <script type="../pro_all_jses/text/javascript" src="ganttTestSuite.js"></script> -->
...
function getDemoProject(){
  ...
  $.ajax({
			type: "POST",
			url:"/system/project?cmd=week_wbs_message&id=<%=p_ids %>",		
			dataType: "json",
			async: false,
			cache: false,
			contentType: false,
...
ret= {tasks, "selectedRow": 0, "deletedTaskIds": [],
      "resources": [
...
<div class="__template__" type="TASKSEDITHEAD"><!--
  <table class="gdfTable" cellspacing="0" cellpadding="0">
    ...
    <tr style="height:40px">
      ...
      <th class="gdfColHeader  gdfResizable"  style="width:80px;">工时(天)</th>
...
<div class="__template__" type="TASKROW"><!--
 <tr id="tid_(#=obj.id#)" taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
    ...
    <td class="gdfCell"><input id="wbs"  type="text" name="code" value="(#=obj.code?obj.code:''#)" placeholder=""></td>
    ...
    <td class="gdfCell"><input type="text" id="start_time" name="start"  value="" class="date"></td>
    <td class="gdfCell" align="center"><input type="checkbox" name="endIsMilestone"></td>
    <td class="gdfCell"><input type="text" id="ENDALL" name="end" value="" class="date"></td>
    <td class="gdfCell"><input type="text" id="APPLN"  name="appln_time" value="" class="date"></td>
    <td class="gdfCell"><input type="text" id="work_time" name="duration" autocomplete="off" value="(#=obj.duration#)"></td>
...
<div class="__template__" type="TASK_EDITOR"><!--
 <div class="ganttTaskEditor">
    ...
    <table id="proj_message" cellspacing="1" cellpadding="5" width="100%" class="taskData table" border="0">
          <tr>
      ...
      <tr class="dateRow">
        <td nowrap="">
          <div style="position:relative">
            ...
            <input type="checkbox" id="startIsMilestone" name="startIsMilestone" value="yes"> &nbsp;<label for="startIsMilestone">是否里程碑</label>&nbsp;
        ...
        <td nowrap="">
          ...
          <input type="checkbox" id="endIsMilestone" name="endIsMilestone" value="yes"> &nbsp;<label for="endIsMilestone">是否里程碑</label>&nbsp;
