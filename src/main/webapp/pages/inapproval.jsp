				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div>
							...
							<!-- <button id="bc" type="button" class="btn btn-default" -->

							<button id="bc" type="button" class="btn btn-success"
								onclick="save(this)">
							...
							<button  id="tj"  type="button" class="btn btn-success"  disabled="disabled"
								onclick="pubRestAudit(this)">
								<span class="glyphicon glyphicon-saved" aria-hidden="true"></span>提交
							</button>
							<button  id="sp" type="button" class="btn btn-info" onclick="pubVisitHis(this)">
								<span class="glyphicon glyphicon-saved" aria-hidden="true"></span>审批进程
							</button>
						</div>
