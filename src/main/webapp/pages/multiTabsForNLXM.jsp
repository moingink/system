	...
	<form>
		<div class="col-md-12">
			<ul id="myTab" class="nav nav-tabs">
				...
				<li class="active"><a href="#1" data-toggle="tab">项目概况</a></li>
		...
		<div class="col-md-12">
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade in active" id='1'>
					<iframe src="maintainPage.jsp?pageCode=PROJ_PROPOSAL&menuCode=1&pageName=项目基本信息&ParentPKField=PROJ_SOURCE_ID&ParentPKValue=<%=request.getParameter("ParentPKValue") %>&state=1" scrolling="no" frameborder="0" width="99%" height="1000"></iframe>
				</div>
				<div class="tab-pane fade" id='3'>
					<iframe src="childTableModify.jsp?pageCode=PROJ_PROGRESS_PHASE_JYS_1&pageName=项目进度阶段划分&ParentPKField=PROJ_SOURCE_ID&ParentPKValue=<%=request.getParameter("ParentPKValue") %>" scrolling="no" frameborder="0" width="99%" height="1000"></iframe>
				</div>
				<div class="tab-pane fade " id='4'>
					<iframe src="" scrolling="no" frameborder="0" width="99%" height="1000"></iframe>
				</div>
				<div class="tab-pane fade " id='5'>
					<iframe src="childTableModify.jsp?pageCode=PROJ_ORGANIZATION_JYS_1&pageName=项目组织架构&ParentPKField=PROJ_SOURCE_ID&ParentPKValue=<%=request.getParameter("ParentPKValue") %>" scrolling="no" frameborder="0" width="99%" height="1000"></iframe>
				</div>
				<div class="tab-pane fade" id='8'>
					<iframe src="childTableModify.jsp?pageCode=PROJ_RISK_MANAGEMENT_JYS_1&pageName=项目风险问题管控&ParentPKField=PROJ_SOURCE_ID&ParentPKValue=<%=request.getParameter("ParentPKValue") %>" scrolling="no" frameborder="0" width="99%" height="1000"></iframe>
				</div>
			</div>
		</div>
