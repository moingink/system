...
<html lang="zh-cn">
	...
	<script type="text/javascript">
		$(function() {
			...
			bulidMaintainPage($("#superInsertPage"),"EC_PURORDER_H_MAIN",mainPageParam);
			bulidListPage($("#table"),'EC_PURORDER_H',pageParamFormat("EC_PURORDER_H_MAIN_ID = <%=request.getParameter("id")%>"));
