			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div>
						...
						<button id="tj" type="button" class="btn btn-primary" onclick="singlePubRestAuditByTenant(this)" buttontoken="audit" disabled="true">
							<span class="glyphicon glyphicon-check" aria-hidden="true"></span>提交
						</button>
						<button type="button" class="btn btn-primary" onclick="singlePubVisitHis(this)" buttontoken="audit">
