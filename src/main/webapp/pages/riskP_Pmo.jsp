...
<script type="text/javascript">
		var products = [
		    ...
		    {productid:'K9-DL-01',name:'否'}
		];
		
		var productses = [
		    {productid:'FI-SW-01',name:'中'},
		    {productid:'K9-DL-01',name:'低'}
		];
		...
		$(function(){
			...
			//	height:250,
				...
				singleSelect:true,
				idField:'itemid',
				url:'/system/project?cmd=find_procj_id&id=<%=p_ids %>',
				columns:[[
		...
		function saverow(target){
            ...
            $('#tt').datagrid('endEdit', getRowIndex(target));
	         ...
	         if(row.INFLUENCE_LEVEL=="中"){row.INFLUENCE_LEVEL="1";}else{row.INFLUENCE_LEVEL="2";}
	         if(row.INTERNAL_SOLUTION=="是"){row.INTERNAL_SOLUTION="1";}else{row.INTERNAL_SOLUTION="0";}
	         if(row.RISK_STATUS=="打开"){row.RISK_STATUS="1";}else{row.RISK_STATUS="0";}
