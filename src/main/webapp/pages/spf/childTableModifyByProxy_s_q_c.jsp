...
<body>
	...
	<form class="form-horizontal">
	  ...
	  <iframe name="query_message" src='query_message_all_q_c.jsp?ParentPKValue=<%=request.getParameter("ParentPKValue")%>' scrolling="no" frameborder="0"  width="99%" height="500px"></iframe>
