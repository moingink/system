			...
			var w = null,
				...
				func = function (data, undefined) {
					...
					if(dat.length && dat[0].id !== undefined && dat[0].parent !== undefined) {
						...
						for(i = 0, j = dat.length; i < j; i++) {
							if(m[dat[i].parent.toString()] == undefined){
								console.log(dat[i].id.toString());
								}
							try{
								m[dat[i].parent.toString()].children.push(dat[i].id.toString());
								p.children_d.push(dat[i].id.toString());
							}catch(ignore){
									//alert('info:'+dat[i]+dat[i].parent+m[dat[i].parent.toString()].children);
							}
...
//								console(ex.name+e.data);
//								document.writeln("Error name: " + e.name);
//								document.writeln("Error name: " + e.message);
							}
		...
		redraw_node : function (node, deep, is_callback, force_render) {
			...
			try{
				...
				console.error(e.name+e.message+node);				
			}
